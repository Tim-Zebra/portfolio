  ...
  return (
    <section id="aboutSection" className="d-flex column justify-content-between portfolioSection">
      ...
      <div id="aboutParagraphs" className='d-flex row col-8 justify-content-center'>
        <p className="text-center col-12">Hello! My name is Timothy Zalewski and the most exciting thing about me right now is that I made a huge career leap!
        ...
        <p className="text-center col-12">I am about half way through UT Austin's Web Development Coding Bootcamp and I am absolutely loving it! What drew me to this career 
